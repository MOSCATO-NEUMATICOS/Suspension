...
export const INITIAL_VEHICLES: Vehicle[] = transformCatalogToVehicles(vehicleCatalogData);

// Predefined synergies are now managed in the admin panel. 
// The primary synergy calculation is dynamic.
export const INITIAL_SYNERGIES: Synergy[] = [];